        ...
        <div class="bg-white shadow-lg rounded-lg flex flex-col lg:flex-row">
            ...
            <div class="w-full lg:w-1/2 p-6">
                <div class="max-w-md mx-auto">
                    ...
                    <form wire:submit.prevent="login" class="mb-8">
                        <div class="mb-4">
                            <input type="email" wire:model="email" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter email" autofocus required>
                        ...
                        <div class="flex items-center mb-4">
                            <input type="checkbox" wire:model="remember" id="remember" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            <label for="remember" class="ml-2 text-sm text-gray-600">Remember me</label>
                        </div>
                        <div class="text-center lg:text-left">                              
                            <button type="submit" class="w-full lg:w-auto px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Sign In</button>
                        </div>
                    </form>
                    <!-- Social Links -->
            ...
            <div class="hidden lg:flex w-1/2 border-l flex-col items-center justify-between p-6 text-center bg-gray-50">
                ...
                <div class="my-8">
                    ...
                    <a href="{{ route('register') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Sign Up</a>
                </div>
