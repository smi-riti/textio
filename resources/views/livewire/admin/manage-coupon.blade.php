                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                @if ($coupon->discount_type !== 'freeShipping')
                                    <strong>Value:</strong> {{ $coupon->discount_value }}
                                    {{ $coupon->discount_type === 'percentage' ? '%' : '₹' }}<br>
                                @endif
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('minimum_purchase_amount') is-invalid @enderror"
                            ...
                            @if ($discount_type !== 'freeShipping')
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span
                                            class="input-group-text">{{ $discount_type === 'percentage' ? '%' : '₹' }}</span>
                                    </div>
