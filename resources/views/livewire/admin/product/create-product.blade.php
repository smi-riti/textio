<div class="min-h-screen bg-gray-50">
    ...
    <div class="p-4 lg:p-8">
        <div class="mx-auto max-w-4xl">
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <button type="button" wire:click="generateSKU"
                                    class="px-4 py-3 bg-gray-100 border border-l-0 border-gray-300 rounded-r-lg hover:bg-gray-200 text-sm font-medium">Generate</button>
                            </div>
                            @error('sku')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_customizable"
                                class="ml-3 text-sm font-medium text-gray-700 cursor-pointer">This product can be
                                customized</label>
                        </div>
                    </div>
                </div>
                    ...
                    @if ($price && $discount_price && $price > $discount_price)
                        <div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-green-800">Discount:
            ...
            @if ($currentStep === 3)
                <div class="rounded-lg bg-white p-6 shadow-sm">
                    <h2 class="mb-6 text-lg font-medium text-gray-900">Variants & Images</h2>
                            ...
                            @foreach ($highlights as $index => $highlight)
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button type="button" wire:click="removeHighlight({{ $index }})"
                                        class="p-2 text-red-600 hover:text-red-800 rounded-lg">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="status"
                                        class="ml-3 text-sm font-medium text-gray-700 cursor-pointer">Active</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" wire:model="featured" id="featured"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                    <label for="featured"
                                        class="ml-3 text-sm font-medium text-gray-700 cursor-pointer">Featured on
                                        homepage</label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex justify-between items-center pt-6 border-t border-gray-200">
                ...
                @else
                    <button type="submit" form="submit-form" wire:loading.attr="disabled"
                        class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700">
                        Create Product
                        <svg wire:loading class="animate-spin w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                stroke-width="4"></circle>
