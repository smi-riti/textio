            ...
            <div class="rounded-lg bg-white p-6">
                ...
                <div class="mb-4">
                    <input type="file" 
                           ...
                           multiple 
                           accept="image/*"
                           class="block w-full p-2 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
