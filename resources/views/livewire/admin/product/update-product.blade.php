    ...
    <div class="p-4 lg:p-8">
        <div class="mx-auto max-w-4xl">
            ...
            <form wire:submit="update" class="space-y-8">
                    ...
                    <div class="rounded-lg bg-white p-6 shadow-sm">
                        ...
                        <div class="mb-8">
                            <h3 class="text-sm font-medium text-gray-700 mb-3">
                                Featured Image @if(!$current_featured_image)<span class="text-red-500">*</span>@endif
                            </h3>
                            
                            <!-- Current Featured Image -->
                            @if($current_featured_image)
                                <div class="mb-4">
                                    <p class="text-sm text-gray-500 mb-2">Current Featured Image:</p>
                                    <div class="relative inline-block">
                                        <img src="{{ $current_featured_image->image_path }}" 
                                             class="w-32 h-32 object-cover rounded-lg border border-gray-300">
                                        <button type="button" wire:click="removeCurrentFeaturedImage"
                            ...
                            <div class="mb-4">
                                @if($current_featured_image)
                                    <p class="text-sm text-gray-500 mb-2">Upload a new featured image to replace the current one (optional):</p>
                                @endif
                            ...
                            @if($featured_image_preview)
                                <div class="mb-4">
                                    <p class="text-sm text-gray-500 mb-2">New Featured Image Preview:</p>
                                    <div class="relative inline-block">
                        ...
                        @if($existing_gallery_images)
                            <div class="mb-6">
                                <h3 class="text-sm font-medium text-gray-700 mb-3">Current Gallery Images</h3>
                        ...
                        <div class="mb-4">
                            <h3 class="text-sm font-medium text-gray-700 mb-3">Add New Gallery Images</h3>
                ...
                @if($currentStep === 4)
                    <div class="rounded-lg bg-white p-6 shadow-sm">
                        <livewire:admin.product.product-variants :product="$product" :variants="$variants" :isEdit="true" />
                    </div>
                @endif
                ...
                <div class="flex justify-between items-center pt-6 border-t border-gray-200">
                    ...
                    @if($currentStep < 5)
                        <button type="button" wire:click="nextStep" 
                                class="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            Next Step
                    ...
                    @else
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <svg wire:loading wire:target="update" class="animate-spin w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24">
