<div x-data="{ buttonLoading: false }" class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="w-full lg:w-8/12 space-y-6">
            ...
            <div class="bg-white rounded-lg p-6 border border-gray-200">
                ...
                <div class="ml-11 border-l-2 border-primary pl-4 py-2" x-data="{ showAll: false }">
                    @forelse ($addresses->take(3) as $address)
                    ...
                    @empty
                        <div class="text-gray-500 text-center py-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                const rzpOptions = {
                    ...
                    handler: function(response) {
                        ...
                        if (!response.razorpay_payment_id || !response.razorpay_order_id || !
                            ...
                            alert('Incomplete payment response. Please contact support with Order #' +
