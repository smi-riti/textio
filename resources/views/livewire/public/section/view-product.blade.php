        ...
        <div class="container mx-auto px-4 py-6">
            ...
            @if ($relatedProducts->isNotEmpty())
                <div class="mb-16">
                    ...
                    <div
                        class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 md:gap-4 px-2 sm:px-3">
                                ...
                                <div class="relative p-1 sm:p-2">
                                    <a href="{{ route('view.product', $relatedProduct->slug) }}">
                                        @if ($relatedProduct->firstVariantImage)
                                            <div
                                                class="aspect-[3/4] bg-gray-50 flex items-center justify-center overflow-hidden rounded-md">
                                        ...
                                        @else
                                            <div
                                                class="aspect-[3/4] bg-gray-50 flex items-center justify-center rounded-md">
                                    ...
                                    <a href="{{ route('view.product', $relatedProduct->slug) }}">
                                        ...
                                        <div class="flex items-center justify-center gap-1 mb-1 sm:mb-2 flex-wrap">
                                            ...
                                            @if ($relatedProduct->discount_price && $relatedProduct->discount_price < $relatedProduct->price)
                                                ...
                                                @if ($discount > 0)
                                                    <span
                                                        class="text-[10px] font-semibold text-green-600 bg-green-50 px-1 py-0.5 rounded-full">
                                                        {{ $discount }}% OFF
                                                    </span>
                                                @endif
                                            @endif
                                        ...
                                        <!-- Product Name -->
                                        <h3
                                            class="text-[#3e3f40] text-[10px] sm:text-xs font-medium text-center line-clamp-2 min-h-[1.5rem] sm:min-h-[1.5rem] leading-tight truncate">
                                            {{ $relatedProduct->name }}
                                        </h3>
                                        <!-- CTA Button -->
                                        <div
                                            class="border border-[#8f4da7] text-[#8f4da7] hover:bg-[#8f4da7] hover:text-white py-1 md:py-2 px-2 rounded-full text-[10px] sm:text-xs font-medium transition-all duration-300 text-center">
