<section class="py-5 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8 px-2 sm:px-4">
            @foreach ($Products as $product)
                <div
                    class="product-card rounded-lg overflow-hidden bg-white shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg w-full max-w-[300px] mx-auto">
                    <div class="relative group">
                        <a wire:navigate href="{{ route('view.product', $product->slug) }}">
                            @if ($product->firstVariantImage)
                                <div class="relative w-full aspect-[4/4] overflow-hidden bg-gray-100">
