    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-accent text-white py-20">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-xl md:text-2xl opacity-90">We'd love to hear from you. Send us a message and we'll respond
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-gray-600 text-lg">Reach out to us through any of the following channels. We're
                            here to help!</p>
                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        <!-- Phone -->
                        <div
                            class="bg-white rounded-2xl p-6 hover:bg-gray-50 transition-all duration-300 border border-gray-200">
                        ...
                        <!-- Address -->
                        <div
                            class="bg-white rounded-2xl p-6 hover:bg-gray-50 transition-all duration-300 border border-gray-200 sm:col-span-2">
                            <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mb-4">
                                <i class="fas fa-map-marker-alt text-green-600 text-xl"></i>
                            </div>
                            <h3 class="font-semibold text-gray-800 mb-2">Address</h3>
                            <p class="text-gray-600">First floor YPN
                                Purnea Bihar 854301</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-gray-200">
                        ...
                        <div class="flex space-x-4">
                            <a href="https://www.facebook.com/share/1FBm4FK3Ud/"
                                class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors duration-300">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="https://www.instagram.com/textio_llp/"
                                class="w-12 h-12 bg-pink-600 rounded-full flex items-center justify-center text-white hover:bg-pink-700 transition-colors duration-300">
                                <i class="fab fa-instagram"></i>
                            </a>
                            {{-- <a href="#"
                                class="w-12 h-12 bg-blue-400 rounded-full flex items-center justify-center text-white hover:bg-blue-500 transition-colors duration-300">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a href="#"
                                class="w-12 h-12 bg-blue-800 rounded-full flex items-center justify-center text-white hover:bg-blue-900 transition-colors duration-300">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="#"
                                class="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center text-white hover:bg-red-700 transition-colors duration-300">
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-200">
                    ...
                    <form wire:submit="submitEnquiry" class="space-y-6">
                        ...
                        <button type="submit"
                            ...
                            wire:loading.attr="disabled" wire:target="submitEnquiry">
